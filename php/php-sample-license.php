...
* Lisans kontrolü için LicenseClass sınıfı çağrılarak LicenseClass::check() ($license->check()) fonksiyonu yazılımınızın kodlarından önce çağrılır.
