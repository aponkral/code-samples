...
Kullanım;
24. satırdan zaman dilimi tanımlanır.
25. satırdan almak istediğiniz verilerin formatı tanımlanır.
26. satırdan zaman tanımlanır. İşlem anındaki o an için zaman bilgisi alınmak isteniyorsa standart time() fonksiyonu kullanılabilir. İsterseniz geçmiş ya da gelecek zaman tanımlanabilir. Unix zaman birimi olarak girilmelidir.
*/
